...
export const CATEGORIES = [
  { name: "Fashion & Beauty", code: "#ff5733", emoji: "👗" },
  { name: "Travel", code: "#33ff57", emoji: "✈️" },
  { name: "Food & Cooking", code: "#3357ff", emoji: "🍱" },
  { name: "Comedy", code: "#ff33a8", emoji: "🎭" },
  { name: "Gaming", code: "#a833ff", emoji: "🎮" },
  { name: "Finance", code: "#33ffa8", emoji: "💼" },
  { name: "Design", code: "#33ffa8", emoji: "🎨" },
  { name: "Health", code: "#ffa833", emoji: "🧘" },
  { name: "Tech", code: "#33a8ff", emoji: "📱" },
  { name: "Music", code: "#ff33ff", emoji: "🎤" },
  { name: "Education", code: "#a8ff33", emoji: "🎓" },
  { name: "Business", code: "#5733ff", emoji: "🛍️" },
  { name: "Memes", code: "#ff5733", emoji: "😂" },
  { name: "Home & Decor", code: "#33ff57", emoji: "🏡" },
  { name: "News", code: "#3357ff", emoji: "📰" },
  { name: "Art", code: "#ff33a8", emoji: "🎨" },
  { name: "Podcasts", code: "#a833ff", emoji: "🎧" },
  { name: "Pets", code: "#33ffa8", emoji: "🐶" },
  { name: "Couple / Relationship", code: "#ffa833", emoji: "👩‍❤️‍👨" },
  { name: "Parenting", code: "#33a8ff", emoji: "👶" },
  { name: "Regional", code: "#ff33ff", emoji: "🇮🇳" },
  { name: "Sports", code: "#33ffa8", emoji: "🏃‍♂️" },
  { name: "Vlogging", code: "#33a8ff", emoji: "📸" },
  { name: "Fitness", code: "#ff33ff", emoji: "🏋️‍♂️" },
  { name: "Motivational", code: "#a8ff33", emoji: "💪" },
  { name: "Real Estate", code: "#5733ff", emoji: "🏠" },
  { name: "DIY", code: "#ff5733", emoji: "🔨" },
  { name: "Pranks", code: "#33ffa8", emoji: "🎥" },
