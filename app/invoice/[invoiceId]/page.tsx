  ...
  return (
    <div className="h-full">
...

      {
        invoice && (
          <Head>
            <title>Invoice #{invoice?.invoiceNumber} | Dodo</title>
            <meta property="og:title" content={`Invoice #${invoice?.invoiceNumber}`} />
            <meta property="og:description" content={`Generated by Dodo for ${invoice?.clientDetails?.name || 'Client'}`} />
            <meta property="og:image" content={`https://dodo-profile-audio.s3.ap-south-1.amazonaws.com/block-images/1744810417694-invoice.png`} />
            <meta property="og:url" content={`https://dodoclub.in/invoice/${invoiceId}`} />
