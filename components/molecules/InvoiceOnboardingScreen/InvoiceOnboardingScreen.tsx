        ...
        >
                    ...
                    <div className="flex flex-col gap-2 justify-center">
                        <div className="flex items-center gap-[10px]">
                            ...
                            <div className="text-sm">
                                Create a clean invoice in under a minute
                            </div>
                        </div>
                        <div className="flex items-center gap-[10px]">
                            <Image src={DoubleTick} alt="double tick" />
                            <div className="text-sm">
                                Share as PDF or link — your choice
                            </div>
                        </div>
                        <div className="flex items-center gap-[10px]">
                            <Image src={DoubleTick} alt="double tick" />
                        ...
                        <div className="flex items-center gap-[10px]">
                            <Image src={DoubleTick} alt="double tick" />
                            <div className="text-sm">
                                Access anytime, safely stored in your dashboard
                            </div>
                        </div>
                    </div>
            ...
            <div className="absolute bottom-0 w-full px-5 py-4 flex flex-col gap-[10px]">
                <div className="flex justify-center gap-1 text-sm">
                    <div className="font-normal">Earn</div>
                    <Image src={DodoCoin} width={20} alt="dodo coin" />
                    <div className="font-semibold">5 dodo coins</div>
