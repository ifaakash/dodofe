...
const AddLink = ({
                ...
                badge: badgeText
                    ? {
                          ...
                          color:
                              BADGES.find(
                                  (badge) =>
                                      badge.text === selectedBadgeCategory
                              )?.color || "",
                      }
                    : null,
            },
    ...
    const validateForm = (): boolean => {
        ...
        if (badgeText?.trim() && !selectedBadgeCategory) {
            setBadgeError(
                "Badge Category is Required when Badge Text is provided"
            );
            isValid = false;
        }
        ...
        try {
            dispatch(
                addBlock({
                    ...
                    hasMedia: !!(
                        uploadedImage || block?.blockData?.linkDisplayPicture
                    ),
                    isNew: true,
                })
            );
        ...
        <div className="py-5 flex flex-col items-center">
            <div className="flex flex-col gap-3 w-full">
                <div className="flex flex-col gap-3">
                    ...
                    >
                        <div
                            className={`bg-[#979EAD] transition-all duration-300 ease-in-out ${
                                displayType === "SMALL"
                    ...
                    <div className="relative">
                        <Input
                            ...
                            icon={PasteIcon}
                            onIconClick={() =>
                                handlePasteFromClipboard(setLink)
                            }
                        ...
                        {BADGES.map((badge) => (
                            ...
                            >
                                <input
                                    ...
                                    value={badge.text}
                                    checked={
                                        selectedBadgeCategory === badge.text
                                    }
                                />
                                <span
                                    className={`text-xs ${
          ...
          <LinkBlock inPreview mode={mode} block={previewBlock} />
            ...
            <div
                className="bottom-0 fixed mb-4 px-4 w-full flex flex-col gap-4 items-center"
                onClick={checkForImage}
            >
                <Switcher
