...
const AnalyticsMain = ({ timeRange, setTimeRange, data }: { timeRange: string, setTimeRange: (value: string) => void, data: any }) => {
  ...
  return (
    <div className='flex flex-col gap-3'>
      ...
      <TabSwitch timeRange={timeRange} setTimeRange={setTimeRange} timeRangeOptions={timeRangeOptions} handleTimeRangeChange={handleTimeRangeChange} />
      ...
      <div className='p-2 flex flex-col bg-white rounded-xl'>
        ...
        <div className='pt-5 pb-2 flex justify-between px-5'>
          ...
          <div className='flex flex-col gap-1'>
            <div className='text-[#414D55] font-bold text-2xl text-center'>{data.avgTime ? data.avgTime + ' sec' : '--'} </div>
            <div className='flex items-center gap-1'>
          ...
          <div className='flex flex-col gap-1'>
            <div className='text-[#414D55] font-bold text-2xl text-center'>{data.ctr ? data.ctr + ' %' : '--'} </div>
            <div className='flex items-center gap-1'>
