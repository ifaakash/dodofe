...
const AnalyticsChart = ({ value1, value2 }: { value1: number, value2: number }) => {
  const hasValues = value1 !== undefined && value2 !== undefined;
  const data = hasValues
    ...
    : [
        { name: "Default 1", value: 40 },
        { name: "Default 2", value: 60 },
      ];

  const total = hasValues ? value1 + value2 : '00';

  const COLORS = hasValues ? ["#924CEA", "#FF7EA2"] : ["#D1D5DB", "#9CA3AF"]; // Green/Orange or Gray Shades
  return (
